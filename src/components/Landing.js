    ...
    return (
        ...
        <div className="our-mission">
            <div className="our-mission-inner">
                ...
                <button><a href="/about" id="oum">Our Mission</a></button>
            </div>
            <img src={working} className="img"/>
        </div>
        <div className="faqsection">
                <div className="faqsection-i">
                    ...
                    <button><a href="/Contact" id="oum">Contact Us</a></button>
                    </div>
                    <img src={searching} className="img-s"/>  
                    </div>
