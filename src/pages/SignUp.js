...
const SignUp = () => {
  ...
  const handleEmailSignUp = async (e) => {
    e.preventDefault();
    const response = await signUp(email, password, firstName);
...
<body className='signup-container'>
      <form onSubmit={handleEmailSignUp} className='signup-form'>
        <div className='signup-header'>
          ...
          <p className='signup-description'>Get Started: Sign Up for Personalised AI-Powered Meal Planning</p>
        </div>
        <input
        ...
        <button type="button" onClick={handleGoogleSignUp} className='tertiary'>
      ...
      <p>Already have an account? <a href='/signin'><span className='login-link'>Log In</span></a></p>
      </div>
      </form>
</body>
